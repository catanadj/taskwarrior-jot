...
class TypedTaskModelTests(unittest.TestCase):
    ...
    def test_heading_command_result_preserves_add_to_contract(self) -> None:
        result = HeadingCommandResult(
            note_kind="task",
            path=Path("task.md"),
            opened=True,
            heading="Next steps",
...
class CliIntegrationTests(JotCliTestCase):
    ...
    def test_no_arguments_prints_command_overview(self) -> None:
        ...
        self.assertIn("active Taskwarrior data directory", result.stdout)
